...
public class ExceptionConstants {
     ...
     * */
    //添加供应商信息失败
    public static final int client_ADD_FAILED_CODE = 7000000;
    public static final String client_ADD_FAILED_MSG = "添加供应商信息失败";
    //删除供应商信息失败
    public static final int client_DELETE_FAILED_CODE = 7000001;
    public static final String client_DELETE_FAILED_MSG = "删除供应商信息失败";
    //修改供应商信息失败
    public static final int client_EDIT_FAILED_CODE = 7000002;
    public static final String client_EDIT_FAILED_MSG = "修改供应商信息失败";
    /**
     * 商品类别信息
     * type = 75
     * */
