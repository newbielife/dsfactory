...
function initTableData() {
    ...
    $('#tableData').datagrid({
        ...
        columns:[[
            ...
            { title: '客户号',field: 'supplier',width:150},
            { title: '客户名称', field: 'contacts',width:50,align:"center"},
            { title: '手机号码', field: 'telephone',width:100,align:"center"},
            { title: '客户类型',field: 'accountNumber',width:80,align:"center"},
            { title: '信用卡', field: 'address',width:100,align:"center"},
